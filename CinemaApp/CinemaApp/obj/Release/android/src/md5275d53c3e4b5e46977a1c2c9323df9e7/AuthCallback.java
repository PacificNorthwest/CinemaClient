package md5275d53c3e4b5e46977a1c2c9323df9e7;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CinemaApp.Security.AuthCallback, CinemaApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AuthCallback.class, __md_methods);
	}
	...
	public AuthCallback () throws java.lang.Throwable
	{
		...
		if (getClass () == AuthCallback.class)
			mono.android.TypeManager.Activate ("CinemaApp.Security.AuthCallback, CinemaApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public AuthCallback (md5508d47e4c93802eb0beedcd6d9d738d1.ConfirmBookingActivity p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == AuthCallback.class)
			mono.android.TypeManager.Activate ("CinemaApp.Security.AuthCallback, CinemaApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "CinemaApp.Activities.ConfirmBookingActivity, CinemaApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
